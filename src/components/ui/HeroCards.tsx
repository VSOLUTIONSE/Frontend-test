...
const HeroCards = () => {
  return (
    <div className="absolute bottom-0  touch-pan-x sm:-left-40 md:-left-5 w-full  md:w-full">
      <div className="flex  w-full gap-x-[13.93px] sm:gap-x-[5.73px]">
        <div className="md:min-w-[260.65px] sm:min-w-[101.61px] sm:max-h-[150px]  max-h-[289px]  mt-[107px] sm:mt-[34.5rem]  bg-white rounded-[13.85px] sm:rounded-[4.85px] shadow-lg ">
          ...
          <div className="md:mt-[14.37px] md:mb-[37.56px] sm:pb-[15.56px]  ml-[11.32px]">
            <h3 className="text-[13.85px] sm:text-[5.93px] md:leading-[18.47px] font-bold">
        ...
        <div className="md:min-w-[244.65px] sm:min-w-[101.61px] sm:max-h-[150px]  max-h-[289px]  mt-[107px] sm:mt-[34.5rem]  bg-white rounded-[13.85px] sm:rounded-[4.85px] shadow-lg ">
          <div className="bg-[#F4F3E8] py-[10.5px] mx-[7.5px] mt-[7.5px] flex items-center justify-center rounded-xl sm:rounded-[6px] md:h-[173.16px]">
            <div className="sm:w-[50px]">
              <Image
