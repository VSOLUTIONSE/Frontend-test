      ...
      <div className="grid  border  grid-cols-3 gap-x-[12px]  gap-y-[5px] ">
        {foodGridData.map((meal, idx) => (
          <div
            key={meal.id}
            className={` ${
              (idx === 0 || idx == 4 || idx == 8) && "z-20"
            } shadow-lg  bg-white rounded-[7.65px] `}
          >
            {/* Image Section */}
            ...
            {/* Content Section */}
            <div className="w-full max-w-[108.56px]  mt-[14.37px] mb-[10.11px] ml-[11.32px]">
              <h3 className="text-[7.65px]  font-bold">{meal.title}</h3>
