    ...
    <section className=" md:h-[935px]  min-h-screen max-w-[1247px]  md:w-full relative touch-pan-x  overflow-x-hidden  bg-[url('/img/home/circles.png')]  sm:mx-auto  bg-cover bg-no-repeat mt-[32px] bg-[#0E0E0E] rounded-[14px] md:ml-[7px]">
      <div className="flex md:w-full  h-auto md:pt-[130px] sm:pt-[130px]  md:mb-[67.48px]  flex-col items-center justify-center text-center mx-auto px-4">
        ...
        <p className="text-white sm:text-[14px] sm:max-w-[269px] max-w-[543px] mb-[40px]  leading-[30px] sm:leading-[21px] text-[20px] font-sans font-normal">
          ...
          Join our Waitlist <span className="sm:hidden">😎</span>
        </p>
        <form className=" flex gap-x-[12px] sm:gap-y-[12px] sm:flex-col  items-center">
          <input
            type="email"
            placeholder="Enter your email"
            className="xl:flex-1 font-sans placeholder:text-[#1A1A1A]  h-[56px] pl-[17px] w-[327px] border border-gray-700 rounded-[12px] focus:outline-none"
          />
