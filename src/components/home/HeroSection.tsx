...
export const HeroSection = () => {
  ...
  return (
    <section className="w-full  md:pr-[48px] sm:px-[24px]">
      <div className="md:h-[935px]  min-h-screen sm:h-[759px]  relative   overflow-x-hidden  bg-[url('/img/home/circles.png')]  sm:mx-auto  bg-cover bg-no-repeat md:mt-[32px]  bg-[#0E0E0E] rounded-[14px] md:ml-[7px] ">
